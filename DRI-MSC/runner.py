...
def add_single_platoon(plexe, topology, step, lane):
    for i in range(PLATOON_SIZE):
        ...
        # traci.vehicle.add(vid, routeID, departPos=str(100-i*(VEHICLE_LENGTH+DISTANCE)), departSpeed=str(5), departLane=str(lane%3), typeID="DEFAULT_VEHTYPE")        
        ...
        traci.vehicle.add(vid, routeID, departPos=str(100-i*(VEHICLE_LENGTH+DISTANCE)), departSpeed=str(5), departLane=str(0), typeID="vtypeauto")        
...
if __name__ == "__main__":
    ...
    # sumo_cmd = ['sumo-gui', '--duration-log.statistics', '--tripinfo-output', 'intelligent_lights_output_file.xml', '-c', 'quickstart.sumocfg']
